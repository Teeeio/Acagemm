  ...
  const startRun = async ({ state, mission, goal, resumeThreadId = null, workspace: requestedWorkspace = null }) => {
    ...
    if (managedCliMode) {
      ...
      const prompt = [
        ...
        'The Workspace intentionally starts without operator code. Create the configured implementation files as this round\'s optimized candidate. Do not search for another baseline. Upstream provenance is provided in the goal/research briefing, and sourceReferences must be recorded from that briefing.',
