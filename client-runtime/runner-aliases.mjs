...
const explicitAliases = new Map([
  ...
  ['gpumuxic550', 'gpu-muxi-c550'],
  ['metaxc550', 'gpu-muxi-c550'],
  ['c550', 'gpu-muxi-c550'],
  ['沐曦c550', 'gpu-muxi-c550'],
  ['muxi', 'gpu-muxi-c550'],
  ['metax', 'gpu-muxi-c550'],
  ['沐曦', 'gpu-muxi-c550'],
  ['模力方舟沐曦', 'gpu-muxi-c550'],
...
export const normalizeRunnerId = (value) => {
  ...
  if (text.includes('c500')) return 'gpu-muxi-c500';
  if (text.includes('muxi') || text.includes('metax') || text.includes('沐曦') || text.includes('c550')) return 'gpu-muxi-c550';
