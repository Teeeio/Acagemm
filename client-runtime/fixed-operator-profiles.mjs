...
export const fixedOperatorTestMatrix = (profileOrId, hardwareName = 'C550') => {
  const profile = typeof profileOrId === 'string' ? getFixedOperatorProfile(profileOrId) : profileOrId;
  const environment = String(hardwareName || 'C550').trim() || 'C550';
