...
assert.equal(normalizeRunnerId('gpu-muxi-c550'), 'gpu-muxi-c550');
assert.equal(normalizeRunnerId('MetaX C550'), 'gpu-muxi-c550');
assert.equal(normalizeRunnerId('沐曦'), 'gpu-muxi-c550');
assert.equal(runnerMatches('C500', 'C550'), false);
